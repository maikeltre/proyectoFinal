...
const enlacesRedes = document.querySelector('.navegacion--redes');
...
function scrollUp() {
    window.onscroll = function () {
        ...
        if (scroll > 50) {
            barraNavegacion.style.backgroundColor = "rgba(0, 0, 0)";
            enlaceProductos.style.backgroundColor = "rgba(0, 0, 0)";
            enlacesRedes.style.backgroundColor = "rgba(0, 0, 0)";
                
        } else if (scroll < 50) {
            barraNavegacion.style.backgroundColor = "transparent";
            enlaceProductos.style.backgroundColor = "transparent";
            enlacesRedes.style.backgroundColor = "transparent";
            }
